...
export const DepositsAddress = ({ currentCoin }: { currentCoin: DepositCoin | undefined }) => {
      ...
      <Box id="depositQR">
        <List className={classes.list}>
          ...
          <List.Item className={classes.listItem}>
            Send only {currentCoin?.symbol} to this deposit address. Sending coin or token other than <br /> {currentCoin?.symbol} to this address may
