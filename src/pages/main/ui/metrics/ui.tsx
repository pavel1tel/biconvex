...
const METRICS = [
  ...
  {
    title: `<span className={classes.dollarSign}>$</span>
                    91M
        ...
        <Stack gap={"clamp(1.5rem, 4vw, 4rem)"}>
          ...
          <Grid gutter={{ 0: 16, md: 32 }}>
            {sm && viewport.isAdaptive ? (
              <div>
                <Carousel className={classes.metricsWrapper} withControls={false} getEmblaApi={setEmbla}>
                  {METRICS.map((METRIC, index) => (
                    <Carousel.Slide className={`${classes.metric}`} key={index}>
                      {/* <div style={{ width: "97%" }}>
              ...
              <>
                ...
                <Grid.Col span={{ md: 6, lg: 3, xl: 3 }} className={classes.metricColumn}>
                  ...
                  >
                    <Stack gap={rem("16px")} className={classes.metricWrapper}>
                      <Group
                        style={{ gap: "clamp(.5rem, 1vw, 1rem)" }}
                        align={"center"}
                        justify={"flex-start"}
                        className={classes.metricTitleWrapper}
                      >
                        <Flex align={"center"} justify={"center"} p={{ 0: 4, md: 8 }} className={classes.metricIconWrapper}>
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
