...
export const FavoriteStarFilledIcon = ({ type, active, handleActive }: { type: "click" | "active"; active?: boolean; handleActive?: () => void }) => {
      ...
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        {type === "active" ? (
          <path
            ...
            fill={active ? "url(#paint0_linear_614_17571)" : "none"} // Conditional fill based on click
            stroke={active ? "none" : "#625FF4"} // Add stroke when not clicked
          />
        ) : (
          <path
            fillOpacity="1.000000"
