(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('effector'), require('effector-react'), require('atomic-router'), require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'effector', 'effector-react', 'atomic-router', 'react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.atomicRouter = {}, global.effector, global.effectorReact, global.atomicRouter, global.React));
})(this, (function (exports, effector, effectorReact, atomicRouter, require$$0) { 'use strict';
  ...
  var RouteLinkView = function RouteLinkView(props, ref) {
    ...
    var _useUnit = effectorReact.useUnit([routeObj.route.$isOpened, to.navigate]),
        isOpened = _useUnit[0],
        navigate = _useUnit[1];
  ...
  function useIsOpened(route) {
    return Array.isArray(route) ? effectorReact.useUnit(route.map(function (route) {
      return route.$isOpened;
    })).some(Boolean) : effectorReact.useUnit(route.$isOpened);
  }
