...
var RouteLinkView = function RouteLinkView(props, ref) {
  ...
  var _useUnit = useUnit([routeObj.route.$isOpened, to.navigate]),
      isOpened = _useUnit[0],
      navigate = _useUnit[1];

  var href = withFactory({
    sid: "oed02r",
    fn: function fn() {
      return buildPath({
...
function useIsOpened(route) {
  return Array.isArray(route) ? useUnit(route.map(function (route) {
    return route.$isOpened;
  })).some(Boolean) : useUnit(route.$isOpened);
}
