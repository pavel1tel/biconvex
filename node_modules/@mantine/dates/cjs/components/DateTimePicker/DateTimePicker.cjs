...
const DateTimePicker = core.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(
    ...
    currentLevel === "month" && /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("timeWrapper") }, /* @__PURE__ */ React__default.default.createElement(
      TimeInput.TimeInput,
      {
        value: timeValue,
        withSeconds,
      ...
      core.ActionIcon,
      {
        ...
        unstyled,
        "data-mantine-stop-propagation": __stopPropagation || void 0,
        children: /* @__PURE__ */ React__default.default.createElement(core.CheckIcon, { size: "30%" }),
        ...submitButtonProps,
        onClick: (event) => {
